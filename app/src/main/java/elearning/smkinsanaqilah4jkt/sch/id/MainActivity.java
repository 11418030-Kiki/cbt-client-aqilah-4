...
import static elearning.smkinsanaqilah4jkt.sch.id.DetectConnection.isNetworkStatusAvialable;
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if(isNetworkStatusAvialable (MainActivity.this)) {
                    ...
                    Toast.makeText(MainActivity.this, "Invalid URl/offline", Toast.LENGTH_LONG).show();
